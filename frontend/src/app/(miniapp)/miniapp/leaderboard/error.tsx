...
export default function MiniappLeaderboardError({
  reset,
}: {
  ...
  return (
    <main className="tg-screen flex min-h-[60vh] items-center justify-center px-5 py-8">
      <section className="tg-card w-full max-w-sm rounded-xl border p-5">
        ...
        <h1 className="tg-title text-xl font-semibold leading-7">Лидерборд недоступен</h1>
        <p className="tg-muted mt-2 text-sm leading-5">
          Не удалось загрузить экран лидерборда.
        </p>
        <button
          type="button"
          onClick={reset}
